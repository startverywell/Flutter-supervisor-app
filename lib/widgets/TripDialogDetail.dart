...
class TripDialogDetail extends StatefulWidget {
  ...
  @override
  _TripDialogDetailState createState() => _TripDialogDetailState();
}

class _TripDialogDetailState extends State<TripDialogDetail> {
